...
>
    ...
    <aside class="relative flex h-full w-72 flex-col overflow-y-auto bg-surface px-4 py-5 shadow-2xl">
        ...
        <button type="button" x-ref="closeNavigation" class="ui-icon-btn absolute right-3 top-3 z-10" aria-label="{{ __('Close navigation') }}" @click="menu = false; $nextTick(() => $refs.navigationToggle.focus())">×</button>
