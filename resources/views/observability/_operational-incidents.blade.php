<section class="ui-card mt-8 p-6" id="operational-incidents">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
            ...
            <h2 class="mt-1 text-xl font-black text-primary">{{ __('Operational incidents') }}</h2>
    ...
    <div class="mt-5 space-y-3">
        @forelse ($operationalIncidents as $incident)
            @php
                $incidentTone = $incident->status === 'resolved'
                    ? 'success'
            ...
            <article class="rounded-xl border border-primary bg-secondary p-4">
                <div class="flex flex-wrap items-start gap-3">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-1 text-sm text-secondary">{{ $incident->summary }}</p>
