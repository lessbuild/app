<x-layouts.app>
    ...
    @endif
    @error('plan')<div class="my-4 rounded-sm border border-red-300 bg-red-50 p-4 text-red-800">{{ $message }}</div>@enderror
