<x-layouts.app>
    ...
    <dl class="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
        ...
        <div class="rounded-lg border border-primary bg-primary p-4">
            ...
            <dd class="mt-1 text-xs text-secondary">{{ __('Matching successful responses.') }}</dd>
        </div>
        <div class="rounded-lg border border-primary bg-primary p-4">
            ...
            <dd class="mt-1 text-xs text-secondary">{{ __('Matching unsuccessful responses.') }}</dd>
        </div>
        <div class="rounded-lg border border-primary bg-primary p-4">
            ...
            <dd class="mt-1 text-xs text-secondary">{{ __('Recorded sample rate, not SLA uptime.') }}</dd>
        </div>
        <div class="rounded-lg border border-primary bg-primary p-4">
            <dt class="text-xs font-semibold uppercase text-secondary">{{ __('Median healthy response') }}</dt>
            <dd class="mt-1 text-2xl font-bold text-primary">
                {{ $metrics['median_healthy_duration_ms'] !== null ? $metrics['median_healthy_duration_ms'].' ms' : __('Not recorded') }}
            </dd>
