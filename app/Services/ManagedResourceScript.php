...
class ManagedResourceScript
{
    /**
     * Render idempotent managed-resource commands without reporting a deployment stage.
     *
     * @param  list<array<string, mixed>>  $resources  Resource declarations from the immutable build snapshot.
     * @return string Shell source for managed Redis, Valkey and PostgreSQL resources.
     */
    public function render(array $resources): string
    {
        ...
        $managedResources = collect($resources)
