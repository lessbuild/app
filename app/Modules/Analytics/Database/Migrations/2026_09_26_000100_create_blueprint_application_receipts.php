...
return new class extends Migration
{
    ...
    {
        Schema::connection('analytics')->create('blueprint_application_receipts', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::connection('analytics')->dropIfExists('blueprint_application_receipts');
    }
};
