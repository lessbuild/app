...
<form class="mt-3 text-center" method="POST" action="{{ route('logout') }}">@csrf<button class="text-sm font-bold text-muted underline hover:text-ink" type="submit">Sign out</button></form>
@endsection
