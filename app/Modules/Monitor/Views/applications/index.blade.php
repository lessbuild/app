...
<div class="space-y-6">
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        @forelse($applications as $application)
            <a href="{{ route('monitor.applications.show', $application) }}" class="ui-card group p-5 transition hover:border-primary dark:hover:border-primary">
                ...
                @if($application->trashed())<p class="mt-3 text-xs text-warning dark:text-warning">Archived · telemetry preserved</p>@endif
            </a>
        @empty
