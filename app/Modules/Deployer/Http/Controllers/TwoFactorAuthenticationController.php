...
use App\Modules\Deployer\Actions\Account\BeginTwoFactorSetupAction;
use App\Modules\Deployer\Actions\Account\CancelTwoFactorSetupAction;
use App\Modules\Deployer\Actions\Account\ConfirmTwoFactorAction;
use App\Modules\Deployer\Actions\Account\DisableTwoFactorAction;
use App\Modules\Deployer\Actions\Account\RegenerateTwoFactorRecoveryCodesAction;
use App\Modules\Deployer\Exceptions\TwoFactorOperationException;
use App\Modules\Deployer\Http\Requests\ConfirmTwoFactorRequest;
use App\Modules\Deployer\Http\Requests\DisableTwoFactorRequest;
use App\Modules\Deployer\Http\Requests\EnableTwoFactorRequest;
use App\Modules\Deployer\Http\Requests\RegenerateTwoFactorRecoveryCodesRequest;
