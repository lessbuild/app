...
>
    ...
    <main id="main-content" tabindex="-1" class="min-h-screen bg-page px-4 py-10 sm:px-6 sm:py-16">
        <div class="mx-auto max-w-3xl">
            ...
            <x-signal.ui.alert class="mt-10" :tone="$operational ? 'success' : 'warning'" role="status" aria-live="polite">
            ...
            @if ($incidents->isNotEmpty())
                <section class="mt-8" aria-labelledby="incident-history-heading">
                    <div class="flex items-end justify-between gap-3">
                        ...
                        <x-signal.ui.badge tone="neutral">{{ $incidents->count() }}</x-signal.ui.badge>
                    </div>
            ...
            <x-signal.ui.card class="mt-8 p-5 sm:p-6">
