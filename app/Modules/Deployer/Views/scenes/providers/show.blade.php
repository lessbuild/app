    ...
    >
        ...
        <div class="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <div @class([
                ...
                'border-success' => $connectionHealth === \App\Modules\Deployer\Models\Provider::CONNECTION_HEALTHY,
                'border-danger' => $connectionHealth === \App\Modules\Deployer\Models\Provider::CONNECTION_FAILED,
                'border-line' => ! in_array($connectionHealth, [
                    \App\Modules\Deployer\Models\Provider::CONNECTION_HEALTHY,
                    \App\Modules\Deployer\Models\Provider::CONNECTION_FAILED,
                ], true),
            ])>
