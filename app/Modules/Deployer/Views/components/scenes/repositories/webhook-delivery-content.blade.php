@php
    ...
    $outcome = match ($delivery->status) {
        \App\Modules\Deployer\Models\RepositoryWebhookDelivery::STATUS_QUEUED => __('A deployment was queued for this push.'),
        \App\Modules\Deployer\Models\RepositoryWebhookDelivery::STATUS_PENDING => __('The push is waiting for the active deployment to finish.'),
        \App\Modules\Deployer\Models\RepositoryWebhookDelivery::STATUS_UNAVAILABLE => __('The deployment target was unavailable when this push was accepted.'),
        \App\Modules\Deployer\Models\RepositoryWebhookDelivery::STATUS_SUPERSEDED => __('A newer push replaced this delivery before it could deploy.'),
        \App\Modules\Deployer\Models\RepositoryWebhookDelivery::STATUS_SKIPPED => __('The configured deployment paths were not affected by this push.'),
