<div data-command-output-content class="space-y-5 p-4 sm:p-5">
    <div class="flex flex-wrap items-start justify-between gap-3">
        ...
        <x-signal.ui.button :href="route('servers.commands.output', ['server' => $server, 'execution' => $execution])" variant="secondary" class="ui-btn-sm">
            {{ __('Download output') }}
        </x-signal.ui.button>
    </div>

    <x-signal.ui.panel class="ui-panel p-3">
