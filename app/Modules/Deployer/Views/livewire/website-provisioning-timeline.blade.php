...
<div @if ($poll) wire:poll.5s @endif>
    ...
    @if ($provisioningStatus && ! in_array($provisioningStatus, [\App\Modules\Deployer\Models\Website::STATUS_ACTIVE, \App\Modules\Deployer\Models\Website::STATUS_FAILED, \App\Modules\Deployer\Services\WebsiteProvisioningTimeline::STATUS_CANCELED], true))
