...
class Organization extends DeployerModel
{
    ...
    /** @return HasManyThrough<PreviewDeployment, Project, $this> */
    public function previews(): HasManyThrough
    {
        return $this->hasManyThrough(PreviewDeployment::class, Project::class);
    }
