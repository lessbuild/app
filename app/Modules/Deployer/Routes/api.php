...
Route::prefix('v1')->middleware('auth:sanctum')->group(function (): void {
    ...
    Route::post('projects/{project}/configuration/plan', [ControlPlaneController::class, 'configurationPlan'])->middleware('control-plane:manage');
    Route::post('projects/{project}/configuration/reviews', [ControlPlaneController::class, 'configurationReview'])->middleware('control-plane:manage');
    Route::post('projects/{project}/configuration/reviews/{review}/apply', [ControlPlaneController::class, 'configurationApply'])->middleware('control-plane:manage');
    Route::get('projects/{project}/configuration/applications/{application}', [ControlPlaneController::class, 'configurationApplication'])->middleware('control-plane:manage');
    Route::post('projects/{project}/configuration/applications/{application}/operations/{operation}/cancel', [ControlPlaneController::class, 'configurationCancel'])->middleware('control-plane:manage');
    Route::post('projects/{project}/configuration/applications/{application}/operations/{operation}/retry', [ControlPlaneController::class, 'configurationRetry'])->middleware('control-plane:manage');
