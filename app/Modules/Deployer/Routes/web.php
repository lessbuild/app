...
use App\Modules\Deployer\Http\Controllers\AccountDeletionController;
use App\Modules\Deployer\Http\Controllers\ActivityController;
...
use App\Modules\Deployer\Http\Controllers\ApplicationConfigurationController;
use App\Modules\Deployer\Http\Controllers\Auth\SocialAuthController;
use App\Modules\Deployer\Http\Controllers\AutomationController;
use App\Modules\Deployer\Http\Controllers\BackupController;
use App\Modules\Deployer\Http\Controllers\BillingController;
use App\Modules\Deployer\Http\Controllers\BuildPromotionController;
use App\Modules\Deployer\Http\Controllers\BuildRevisionCallbackController;
use App\Modules\Deployer\Http\Controllers\BuildsController;
use App\Modules\Deployer\Http\Controllers\Callbacks\BuildCallbackController;
use App\Modules\Deployer\Http\Controllers\Callbacks\ServerCallbackController;
use App\Modules\Deployer\Http\Controllers\Callbacks\WebsiteCallbackController;
use App\Modules\Deployer\Http\Controllers\CommandsController;
use App\Modules\Deployer\Http\Controllers\CostController;
use App\Modules\Deployer\Http\Controllers\CreationDialogController;
use App\Modules\Deployer\Http\Controllers\DashboardController;
use App\Modules\Deployer\Http\Controllers\DatabaseController;
use App\Modules\Deployer\Http\Controllers\DomainController;
use App\Modules\Deployer\Http\Controllers\EnterpriseSsoController;
use App\Modules\Deployer\Http\Controllers\EnvironmentController;
use App\Modules\Deployer\Http\Controllers\GitHubAppController;
use App\Modules\Deployer\Http\Controllers\GitHubAppSetupController;
use App\Modules\Deployer\Http\Controllers\ImportServerController;
use App\Modules\Deployer\Http\Controllers\ImportWebsiteController;
use App\Modules\Deployer\Http\Controllers\LoadBalancerController;
use App\Modules\Deployer\Http\Controllers\NotificationsController;
...
use App\Modules\Deployer\Http\Controllers\ProviderConnectionController;
use App\Modules\Deployer\Http\Controllers\ProviderController;
use App\Modules\Deployer\Http\Controllers\ProviderServerCatalogController;
use App\Modules\Deployer\Http\Controllers\PublicPageController;
use App\Modules\Deployer\Http\Controllers\PublicStatusPageController;
use App\Modules\Deployer\Http\Controllers\RecipeFavoritesController;
use App\Modules\Deployer\Http\Controllers\RecipeGalleryController;
use App\Modules\Deployer\Http\Controllers\RecipeRatingsController;
use App\Modules\Deployer\Http\Controllers\RecipeReportsController;
use App\Modules\Deployer\Http\Controllers\RecipesController;
use App\Modules\Deployer\Http\Controllers\RepositoriesController;
use App\Modules\Deployer\Http\Controllers\RepositoryWebhookSettingsController;
use App\Modules\Deployer\Http\Controllers\SearchController;
use App\Modules\Deployer\Http\Controllers\ServerCommandsController;
use App\Modules\Deployer\Http\Controllers\ServersController;
use App\Modules\Deployer\Http\Controllers\ServerTroubleshootingController;
use App\Modules\Deployer\Http\Controllers\SignInHistoryController;
use App\Modules\Deployer\Http\Controllers\StatusSubscriptionController;
use App\Modules\Deployer\Http\Controllers\SystemHealthController;
use App\Modules\Deployer\Http\Controllers\TwoFactorAuthenticationController;
...
Route::middleware([
    ...
    Route::middleware('verified')->group(function () {
        ...
        Route::get('projects/{project}/configuration/observe', [ApplicationConfigurationController::class, 'observe'])->name('projects.configuration.observe');
        Route::get('projects/{project}/configuration/dialog', [ApplicationConfigurationController::class, 'dialog'])->name('projects.configuration.dialog');
