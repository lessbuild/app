...
final class MarketingPagesTest extends TestCase
{
    ...
    public function test_core_pricing_page_preserves_independent_configured_product_catalogs(): void
    {
        $html = $this->get(route('core.pricing'))
            ...
            ->assertSee('data-pricing-tabs', false)
            ->assertSee('role="tablist"', false)
            ->assertSee('role="tab"', false)
            ->assertSee('aria-controls="pricing-panel-deployer"', false)
            ->assertSee('aria-controls="pricing-panel-monitor"', false)
            ->assertSee('aria-controls="pricing-panel-analytics"', false)
            ->assertSee('$199')
            ->assertSee('$29')
